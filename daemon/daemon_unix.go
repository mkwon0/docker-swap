...
func getMemoryResources(config containertypes.Resources) *specs.Memory {
	...
	if config.MemorySwapfile != nil {
		swapfile := string(*config.MemorySwapfile)
		memory.Swapfile = &swapfile
	}
...
func (daemon *Daemon) adaptContainerSettings(hostConfig *containertypes.HostConfig, adjustCPUShares bool) error {
	...
	if hostConfig.MemorySwapfile == nil {
		defaultSwapfile := "default"
		hostConfig.MemorySwapfile = &defaultSwapfile
	}
